...
public class IJCalibration implements Cloneable, Serializable {
    ...
    public IJCalibration(ImagePlus imp) {
        if (imp!=null) {
    ...
    public IJCalibration(Calibration oldCalib) {
        ...
        pixelHeight = oldCalib.pixelHeight;
        frameInterval = oldCalib.frameInterval;
        fps = oldCalib.fps;
        info = oldCalib.info;
        ...
        yOrigin = oldCalib.yOrigin;
        zOrigin = oldCalib.zOrigin;
        unit = oldCalib.getUnit();
        yunit = oldCalib.getYUnit();
        zunit = oldCalib.getZUnit();
        units = oldCalib.getUnits();
